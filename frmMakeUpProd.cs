...
namespace MainMenu
{
    public partial class frmMakeUpProd : Form
    {
        ...
        {
            string sql = "SELECT P_Code+'  '+P_Descrip as PName FROM PRD_PROCESS WHERE P_CODE IN ('004','005','006','007','008')ORDER BY P_CODE";
...
//                    con.Open();
                    String sql1 = "SELECT * FROM MKUPPROD WHERE ENO ='" + EmpCode + "' and DATE= '" + dtProd.Value.Date + "' and SHIFT= '" + txtShift.Text + "' and P_CODE= '" + ProcCode + "' and G_CODE= '" + GroupCode + "' AND LOC='" + general.strLoc + "' ";
...
//                    con.Close();
 ...
 //           con.Open();
            String sqlM = "SELECT * FROM MKUPPROD WHERE ENO ='" + EmpCode + "' and Date= '" + dtProd.Value.Date + "' and shift= '" + txtShift.Text + "' and P_code= '" + ProcCode + "' and  G_CODE= '" + GroupCode + "' AND LOC='" + general.strLoc + "' ";
            SqlDataAdapter sdaM = new SqlDataAdapter(sqlM, con);
            DataTable dtM = new DataTable();
            sdaM.Fill(dtM);
            if (dtM.Rows.Count > 0)
            {
                String sql2 = "UPDATE MKUPPROD SET W_TIME= '" + txtTime.Text + "',PROD='" + txtProd.Text + "'     WHERE ENO ='" + EmpCode + "' and Date= '" + dtProd.Value.Date + "' and shift= '" + txtShift.Text + "' and P_code= '" + ProcCode + "' and G_CODE= '" + GroupCode + "'  AND LOC='" + general.strLoc + "' ";
            ...
            else
            {
                ...
                String sql = "INSERT INTO MKUPPROD (ENO,DATE,SHIFT, P_CODE, G_CODE,  W_TIME, PROD,LOC) values('" + EmpCode + "','" + dtProd.Value.Date + "','" + txtShift.Text + "', '" + ProcCode + "', '" + GroupCode + "', '" + txtTime.Text + "','" + txtProd.Text + "','" + general.strLoc + "')";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.ExecuteNonQuery();
...
//                con.Close();
        ...
        private void cmdDelete_Click(object sender, EventArgs e)
        {
            ...
            {
//                con.Open();
                String sql = "DELETE FROM MKUPPROD  WHERE ENO ='" + EmpCode + "' and Date= '" + dtProd.Value.Date + "' and shift= '" + txtShift.Text + "' and P_code= '" + ProcCode + "' and G_CODE= '" + GroupCode + "'  AND LOC='" + general.strLoc + "' ";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.ExecuteNonQuery();
